function addToCart(productName="yumurta", quantity){
   ...
   addToCart(); // BEN ASLINDA YOĞUM. parametreye bir değer göndermesek de default değeri geldi
   addToCart("ELMA",5);
   addToCart(15,3);
   addToCart(14);// ADET undefined oldu.İlk parametreyi göndermişiz gibi oldu.Parametreler sırasıyla oldu
   
//function yazmamızın sebebi tekrar satırlarını ortadan kaldırmaktır.
